...
def train(model, local_rank):
    ...
    if args.pretrained:
        ...
        args.modelDir='/media/gky-u/DATA/z/new/arXiv2020-RIFE/train_log'
        from model.RIFE_HDv2 import Model
        model = Model()
        model.load_model(args.modelDir, -1)
        print("Loaded v2.x HD pretrained model.")
...
if __name__ == "__main__":  
    ...
    train(model, args.local_rank)
        ...
        # python3 -m torch.distributed.launch --nproc_per_node=4 train.py --world_size=4 --epoch=1000 --batch_size=48
        # python -m torch.distributed.launch --nproc_per_node=1 trainv2.py --world_size=1 --epoch=2
