...
def evaluate(model, val_data, nr_eval, local_rank, writer_val):
    ...
    if local_rank == 0:
        ...
        # print(loss_l1_list,"loss_l1_list")
        # print(np.array(loss_l1_list).mean(),'mean')
...
if __name__ == "__main__":    
    ...
    train(model, args.local_rank)
        # python -m torch.distributed.launch --nproc_per_node=3 train.py --world_size=3 --epoch=1000 --batch_size=48
        # python -m torch.distributed.launch --nproc_per_node=1 --master_port 9527 train.py --world_size=1 --epoch=2
        # python -m torch.distributed.launch --nproc_per_node=1 train.py --world_size=1 --epoch=2
